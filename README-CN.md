...
## [README of English](https://github.com/csdjywyq/aliyun-oss-go-sdk/blob/master/README.md)
...
## 安装方法
### GitHub安装
> - 执行命令`go get github.com/csdjywyq/aliyun-oss-go-sdk/oss`获取远程代码包。
> - 在您的代码中使用`import "github.com/csdjywyq/aliyun-oss-go-sdk/oss"`引入OSS Go SDK的包。
...
或者参看`https://github.com/csdjywyq/aliyun-oss-go-sdk`下sample目录中的示例文件。
